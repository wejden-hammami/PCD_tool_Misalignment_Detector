...
def analyze_commit_mismatch(message: str, diff: str) -> dict:
    """Compare a commit message against its diff and return issue + suggested message."""
...
CODE DIFF (truncated to {DIFF_PREVIEW_LEN} chars)
-------------------------------------
{diff_preview}
...
def analyze_comment(comment: dict) -> dict:
    """Classify a review comment for confusion and predicted change requests."""
